...
class _ObjectiveFunctionWrapper:
    ...
    def __call__(
        ...
        if argc == 2:
            ...
            raise TypeError(
                f"Self-defined objective function should have 2, 3 or 4 arguments, got {argc}"
            )
        return grad, hess
...
class _EvalFunctionWrapper:
    ...
    def __call__(
        ...
        if argc == 2:
            ...
            raise TypeError(
                f"Self-defined eval function should have 2, 3 or 4 arguments, got {argc}"
            )
...
class LGBMModel(_LGBMModelBase):
    ...
    def _process_params(self, stage: str) -> Dict[str, Any]:
        ...
        for alias in _ConfigAliases.get("objective"):
            if alias in params:
                ...
                _log_warning(
                    f"Found '{alias}' in params. Will use it instead of 'objective' argument"
                )
                if stage == "fit":
                    self._objective = obj
        if stage == "fit":
        ...
        if hasattr(self, "_eval_at"):
            ...
            for alias in _ConfigAliases.get("eval_at"):
                if alias in params:
                    _log_warning(
                        f"Found '{alias}' in params. Will use it instead of 'eval_at' argument"
                    )
    ...
    def predict(
        ...
        **kwargs: Any,
        ...
        predict_params["num_threads"] = self._process_n_jobs(
            predict_params["num_threads"]
        )
...
class LGBMRanker(LGBMModel):
    ...
    _before_feature_name, _feature_name, _after_feature_name = _base_doc.partition(
        "feature_name :"
    )
