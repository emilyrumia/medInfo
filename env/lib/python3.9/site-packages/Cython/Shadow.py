...
annotation_typing = (
    ...
    py2_import
) = iterable_coroutine = remove_unreachable = lambda _: _EmptyDecoratorAndManager()
...
final = (
    internal
) = type_version_tag = no_gc_clear = no_gc = total_ordering = ufunc = _empty_decorator
...
class warn:
    undeclared = (
        ...
        maybe_uninitialized
    ) = unused = unused_arg = unused_result = lambda _: _EmptyDecoratorAndManager()
