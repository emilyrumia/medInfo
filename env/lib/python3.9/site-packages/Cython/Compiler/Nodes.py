...
class CheckAnalysers(type):
    ...
    methods = frozenset(
        {"analyse_types", "analyse_expressions", "analyse_target_types",}
    )
    ...
    def analyse(
        ...
        if (
            ...
            if self.exception_value:
                if self.exception_check == "+":
                    self.exception_value = self.exception_value.analyse_const_expression(
                        env
                    )
            ...
            if ttype is None:
                ...
                if ttype.equivalent_type and not template_node.as_cython_attribute():
                    ...
                    error(
                        ...
                        % (base_type.python_type_constructor_name, ttype,),
                    )
                    ttype = error_type
...
class DefNode(FuncDefNode):
    ...
    def analyse_signature(self, env):
        ...
        if (
            ...
            ) = TypeSlots.pyfunction_signature  # self is not 'really' used
        ...
        if new_type.from_py_function:
            code.putln(
                new_type.from_py_call_code(
                    arg.hdr_cname, arg.entry.cname, arg.pos, code,
                )
            )
        else:
            error(
    ...
    def generate_type_ready_code(
        ...
        # TODO: remove 'else:' and dedent
            ...
            if type.vtable_cname:
                ...
                code.put_error_if_neg(
                    entry.pos,
                    "__Pyx_SetVtable(%s, %s)" % (typeptr_cname, type.vtabptr_cname,),
                )
