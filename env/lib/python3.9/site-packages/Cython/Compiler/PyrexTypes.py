...
class PyrexType(BaseType):
    ...
    generate_incref = (
        ...
        generate_xgotref
    ) = generate_giveref = generate_xgiveref = _generate_dummy_refcounting
...
class MemoryViewSliceType(PyrexType):
    ...
    def create_to_py_utility_code(self, env):
        (
            self._dtype_to_py_func,
            self._dtype_from_py_func,
    ...
    generate_gotref = (
        generate_xgotref
    ) = generate_xgiveref = generate_giveref = lambda *args: None
...
class SoftCComplexType(CComplexType):
    ...
    def declaration_code(self, entity_code, for_display=0, dll_linkage=None, pyrex=0):
        base_result = super(SoftCComplexType, self).declaration_code(
            entity_code, for_display=for_display, dll_linkage=dll_linkage, pyrex=pyrex,
        )
        if for_display:
...
def write_noexcept_performance_hint(pos, env, function_name=None, void_return=False):
    ...
    solutions = [
        "Declare the function as 'noexcept' if you control the definition and "
