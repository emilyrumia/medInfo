...
class ModuleNode(Nodes.Node, Nodes.BlockNode):
    ...
    def analyse_declarations(self, env):
        ...
        if not Options.docstrings:
            ...
            env.doc = EncodedString(
                u"File: %s (starting at line %s)" % Nodes.relative_position(self.pos)
            )
    ...
    def generate_new_function(self, scope, code, cclass_entry):
        ...
        (
            have_entries,
            (py_attrs, py_buffers, memoryview_slices),
    ...
    def generate_binop_function(self, scope, slot, code, pos):
        ...
        if get_slot_method_cname(
            ...
            warning(
                ...
                % (slot.left_slot.method_name, slot.right_slot.method_name,),
            )
    ...
    def generate_module_init_func(self, imported_modules, env, code):
        ...
        code.putln(
            "if (%s == %s) return 0;"
            % (Naming.module_cname, Naming.pymodinit_module_arg,)
        )
        code.putln(
    ...
    def wrong_punycode_module_name(self, name):
        ...
        try:
            ...
            return "PyInitU" + (u"_" + name).encode("punycode").replace(
                b"-", b"_"
            ).decode("ascii")
